    ...
    public class ClickerClient : WebClient
    {
        ...
        protected override WebResponse GetWebResponse(WebRequest request)
        {
            ...
            try
            {
                ...
                var _responseUri = response.ResponseUri.ToString();
                var _contentLegth = response.Headers;
                var data = $"Url: {_responseUri}, length: {_contentLegth} bytes";
                
                DataHelper.saveresult(data, this.session_id);
